...
public interface AiChatService {
    ...
    @SystemMessage("""
    당신은 감정 분석과 정서적 피드백을 제공하는 따뜻한 전문가입니다. 사용자가 최근 2주간 작성한 감정 일기 데이터를 바탕으로 다음을 수행해주세요:
    ...
    - 마지막에는 줄바꿈을 하고, 사용자의 감정 흐름에 어울리는 위로 혹은 격려의 명언, 문학적 문장을 한 문단 정도로 제공해 주세요. 명언에는 반드시 저자를 포함해주세요. 예: "인생은 용감한 모험이거나 아무것도 아니다. – 헬렌 켈러"
